...
public class SystemAccidents extends JPanel implements ActionListener {
	...
	public SystemAccidents() {

		// リストの初期化
		listModel = AnalysisData.getInstance().getAccidentData();
		...
		add(new JLabel("Accident list"), new TMGridBagConstraints(0, 6, 2, 1));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (actionCommand.equals("AddButton")) {
			...
			if (titleField.getText().length() > 0) {
				...
				myData.setId("A-" + (listModel.size() + 1));
